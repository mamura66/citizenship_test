...
const STRINGS = {
  ...
  fr: {
    /* French, for Canada. Canadian French, and the vocabulary IRCC itself uses: 'examen'
     rather than 'test' for the citizenship exam, 'note de passage' for the pass mark,
     'Chambre des communes' and 'gouverneur général'. Register is 'vous', which is what
     the guide uses when it addresses a candidate.

     Unlike German and Spanish, 'Entrevue' is kept for the read-aloud mode: Canada does
     hold interviews with a citizenship official, so unlike the German and Spanish written
     papers the word describes something that exists. */
    'boot.loading': "Chargement de votre compte…",
    'gate.title': "Pour quel pays passez-vous l'examen de citoyenneté?",
    'gate.explain': "Cela détermine vos questions, votre note de passage et vos réponses locales. Ce choix reste attaché à votre compte, alors choisissez le pays où vous faites réellement votre demande.",
    'gate.coming': "À venir",
    'gate.note': "Aujourd'hui, vous pouvez choisir {countries}. Les autres sont indiqués pour que vous voyiez où cela s'en va : chacun est un ensemble de questions, pas un autre site.",
    'gate.note.none': "Aucun pays n'est prêt à être choisi dans ce navigateur pour le moment. Chacun est un ensemble de questions, pas un autre site : cette liste se remplit à mesure qu'ils arrivent.",
    'gate.setting': "Préparation de vos questions…",
    'list.and': "et",
    'country.us': "États-Unis",
    'country.us.prose': "les États-Unis",
    'country.de': "Allemagne",
    'country.es': "Espagne",
    'country.ca': "Canada",
    'country.uk': "Royaume-Uni",
    'country.uk.prose': "le Royaume-Uni",
    'country.au': "Australie",
    'rail.version': "Version de l'examen",
    'rail.versionNote': "Étudiez la version qui s'applique à votre propre demande.",
    'rail.versionsLabel': "Quelle version de {test} étudier",
    'rail.versionSwitchConfirm': "Changer de version annulera l'examen d'entraînement en cours. Continuer?",
    'rail.versionSwitched': "Vous étudiez maintenant : {label}.",
    'rail.versionFailed': "Cette version n'a pas pu être chargée. Vous êtes toujours sur celle que vous utilisiez.",
    'rail.mode': "Mode",
    'rail.sections': "Sections",
    'rail.allSections': "Toutes les sections",
    'rail.backToSite': "← Retour au site",
    'rail.support': "Soutien",
    'rail.terms': "Conditions",
    'rail.privacy': "Confidentialité",
    'rail.signOut': "Se déconnecter",
    'who.fullAccess': "Accès complet",
    'who.freeAccount': "Compte gratuit",
    'mode.study': "Étudier",
    'mode.practice': "Examen d'entraînement",
    'mode.interview': "Entrevue",
    'mode.performance': "Votre progression",
    'mode.insights': "Insights",
    'badge.paid': "Payant",
    'badge.owner': "Propriétaire",
    'theme.dark': "Sombre",
    'theme.light': "Clair",
    'theme.toDark': "Passer au mode sombre",
    'theme.toLight': "Passer au mode clair",
    'study.crumbAll': "Toutes les sections · gratuit pour toujours",
    'study.title': "Cartes-éclair",
    'study.sub': "Toutes les questions officielles, gratuitement et pour toujours. Cliquez sur la carte pour voir les réponses acceptées.",
    'study.subSubset': "Gratuit pour toujours. Cliquez sur la carte pour voir les réponses acceptées.",
    'pack.about': "À propos de ces questions",
    'pack.licence': "Matériel officiel de {attribution}, reproduit sous {licence}.",
    'pack.licenceLink': "Conditions de la licence",
    'pack.extraRule': "Une règle de plus",
    'pack.source': "Source : {attribution}",
    'study.figureAlt': "L'image imprimée avec cette question dans le catalogue officiel",
    'study.empty': "Aucune question dans cette section.",
    'study.questionLabel': "Question {id}",
    'study.clickReveal': "Cliquez pour voir la réponse",
    'study.clickBack': "Cliquez pour revenir",
    'study.acceptedAnswers': "Réponses acceptées · {n}",
    'study.answer': "Réponse",
    'study.anyOne': "N'importe laquelle de ces réponses est acceptée.",
    'study.officialOptions': "Les choix de réponse tels qu'ils sont imprimés",
    'study.needsPicture': "Cette question se répond à partir d'images imprimées dans le catalogue officiel. Elles ne sont pas reproduites ici, alors elle n'est pas posée dans un examen d'entraînement.",
    'study.needsPicturePage': "Cette question se répond à partir d'images imprimées dans le catalogue officiel (page {page}). Elles ne sont pas reproduites ici, alors elle n'est pas posée dans un examen d'entraînement.",
    'study.correctAnswer': "Bonne réponse",
    'study.card': "Carte {n}",
    'btn.previous': "Précédente",
    'btn.nextQuestion': "Question suivante",
    'practice.crumb': "Examen d'entraînement",
    'practice.title': "Examen d'entraînement",
    'practice.sub': "À l'examen réel, on vous pose jusqu'à {asked} questions et il faut {pass} bonnes réponses pour réussir. Cet examen utilise le même format.",
    'practice.subUnknown': "Cet examen utilise le même format que l'examen réel.",
    'practice.card': "{asked} questions · {pass} pour réussir",
    'practice.cardUnknown': "Même format que l'examen réel",
    'practice.unlimited': "Les examens illimités font partie de votre accès.",
    'practice.firstFree': "Votre premier examen complet est gratuit.",
    'practice.unavailable': "Cet ensemble de questions n'indique pas combien de questions comporte l'examen réel ni combien de bonnes réponses il faut, alors un examen d'entraînement au format réel ne peut pas encore être créé. Tout ce qui se trouve dans Étudier est disponible.",
    'btn.startTest': "Commencer l'examen",
    'practice.questionOf': "Question {n} sur {total}",
    'practice.selectOne': "Choisissez une réponse",
    'practice.selectN': "Choisissez {n} réponses",
    'practice.optsLabel': "{instruction} : {question}",
    'opt.correctYours': "Bonne réponse, la vôtre",
    'opt.correct': "Bonne réponse",
    'opt.yoursIncorrect': "Votre réponse, incorrecte",
    'opt.selected': "Sélectionnée",
    'btn.seeResults': "Voir les résultats",
    'verdict.correct': "Exact.",
    'verdict.incorrect': "Ce n'est pas exact.",
    'verdict.answerIs': "La réponse est {answers}.",
    'verdict.answersAre': "Les réponses sont {answers}.",
    'paused.title': "Vous avez un examen en cours",
    'paused.sub': "En pause à la question {n} sur {total}. Rien de ce que vous avez répondu n'est perdu.",
    'paused.label': "En pause",
    'paused.correctSoFar': "{n} bonnes réponses jusqu'ici · {pass} nécessaires pour réussir.",
    'paused.correctSoFarNoMark': "{n} bonnes réponses jusqu'ici.",
    'btn.resumeTest': "Reprendre l'examen",
    'btn.discardTest': "Abandonner et commencer un nouvel examen",
    'paused.freeNote': "C'est votre examen gratuit. En le reprenant, vous continuez là où vous étiez.",
    'results.crumb': "Résultats",
    'results.pass': "Réussi",
    'results.notYet': "Pas encore",
    'results.sub': "{correct} bonnes réponses sur {total} ({pct} %) — il en fallait {pass} pour réussir.",
    'results.review.one': "Revoir la {n} que vous avez manquée",
    'results.review.other': "Revoir les {n} que vous avez manquées",
    'btn.backToPractice': "Retour à l'entraînement",
    'interview.crumb': "Entrevue",
    'interview.title': "Entraînement à l'entrevue",
    'interview.sub': "La question est lue à voix haute. Vous répondez à voix haute, puis vous vérifiez vous-même.",
    'interview.label': "Intervieweur d'entraînement",
    'btn.readAloud': "Lire à voix haute",
    'interview.noSpeech': "La synthèse vocale n'est pas prise en charge ici",
    'btn.revealAnswer': "Afficher la réponse",
    'btn.anotherQuestion': "Une autre question",
    'interview.privacy': "C'est votre navigateur qui lit la question. Le microphone n'est jamais utilisé et aucun son n'est enregistré.",
    'perf.label': "Votre progression",
    'perf.whereYouStand': "Où vous en êtes",
    'perf.onTrack': "Sur la bonne voie",
    'perf.notThereYet': "Pas encore là",
    'perf.headlineEmpty': "Rien ici n'est estimé. Répondez à une question et cette page se remplira avec vos propres résultats.",
    'perf.headlineAbove': "Vous répondez au-dessus de la note de passage de {pct} %.",
    'perf.headlineBelow': "Vous êtes sous la note de passage de {pct} %.",
    'perf.headlineNoMark': "Voici votre taux de réussite sur les questions auxquelles vous avez réellement répondu.",
    'perf.weakest': "Point faible : {label}, à {pct} %.",
    'perf.startWith': "Commencez par ceci : {label}, actuellement à {pct} %.",
    'perf.poolSeen': "De l'ensemble, vues",
    'perf.testsFinished': "Examens terminés",
    'perf.dayStreak': "Jours d'affilée",
    'perf.latestScore': "Dernier résultat",
    'perf.answersRecorded': "Réponses enregistrées",
    'perf.map': "Votre carte de l'examen",
    'perf.notAskedYet': "Pas encore posée",
    'perf.answeredRight': "Bonne réponse",
    'perf.answeredWrong': "Mauvaise réponse",
    'perf.keyRight': "bonnes",
    'perf.keyWrong': "mauvaises",
    'perf.keyUnasked': "pas encore posées",
    'perf.scores': "Résultats · {n} derniers",
    'perf.answersPerDay': "Réponses par jour · {days}",
    'perf.answersOn.one': "{n} réponse le {when}",
    'perf.answersOn.other': "{n} réponses le {when}",
    'perf.nothingOn': "Rien le {when}",
    'perf.accuracyBySection': "Taux de réussite par section · les plus faibles d'abord",
    'perf.studySection': "Étudier {label}, actuellement {pct} % de bonnes réponses",
    'perf.notTested.one': "Pas encore testée · {n} section",
    'perf.notTested.other': "Pas encore testées · {n} sections",
    'perf.notTestedNote': "Affichées à part volontairement : ne jamais avoir été posée n'est pas la même chose qu'avoir été manquée.",
    'perf.ringNone': "Aucune réponse enregistrée pour l'instant",
    'perf.ringLabel': "Taux de réussite {pct} pour cent, note de passage {passPct} pour cent",
    'perf.ringLabelNoMark': "Taux de réussite {pct} pour cent",
    'perf.accuracyCap': "RÉUSSITE",
    'perf.trendLabel': "Vos {n} derniers résultats, du plus ancien au plus récent, le dernier à {pct} pour cent",
    'perf.passMarkCap': "note de passage {pct} %",
    'btn.takeTest': "Faire un examen d'entraînement",
    'paywall.title': "{what} fait partie de l'accès complet",
    'paywall.body': "Tout ce que vous étudiez reste gratuit. L'accès complet ajoute les examens d'entraînement illimités et l'entraînement à l'entrevue.",
    'paywall.oneTime': "Une seule fois · sans abonnement",
    'paywall.tax': "Plus les taxes applicables dans votre pays. Paddle vous montre le total avant le paiement.",
    'paywall.unlockFor': "Débloquer pour {price}",
    'paywall.unlimitedTests': "Examens d'entraînement illimités",
    'paywall.notOnSale': "Pas encore en vente",
    'paywall.salesPaused': "L'accès complet sera bientôt en vente : notre fournisseur de paiement termine encore les vérifications de notre compte. Tout ce qui est gratuit est disponible dès maintenant, et il n'y a rien à payer pour continuer à étudier.",
    'paywall.notConfigured': "L'accès complet n'est pas encore en vente sur le site. Tout ce qui est gratuit est disponible dès maintenant.",
    'paywall.opening': "Ouverture du paiement…",
    'paywall.windowFailed': "La fenêtre de paiement n'a pas pu se charger. Vérifiez votre connexion et réessayez.",
    'paywall.footer': "Le paiement est traité par Paddle, notre revendeur. Vos données de carte ne nous parviennent jamais. Paiement unique, sans abonnement — voir les <a href=\"/refunds\">remboursements</a> et les <a href=\"/terms\">conditions</a>.",
    'checkout.failed': "Le paiement n'a pas pu s'ouvrir ({detail}). Rien n'a été facturé. Veuillez réessayer ou nous écrire, et nous réglerons cela.",
    'confirm.title': "Merci — confirmation de votre paiement",
    'confirm.sub': "Cela prend habituellement quelques secondes.",
    'confirm.waiting': "Votre banque traite encore le paiement. En attente…",
    'confirm.stuck': "Votre paiement est passé, mais la confirmation ne nous est pas encore parvenue. Elle arrive normalement en une ou deux minutes. Vérifiez de nouveau ci-dessous — et si l'accès complet manque toujours, envoyez-nous le reçu que Paddle vous a envoyé par courriel et nous corrigerons cela immédiatement.",
    'btn.checkAgain': "Vérifier de nouveau",
    'btn.contactSupport': "Écrire au soutien",
    'sandbox.banner': "Environnement de test Paddle — les paiements sur cette page sont des tests, aucun argent ne change de main.",
    'error.bootTitle': "Une erreur est survenue au chargement de votre compte",
