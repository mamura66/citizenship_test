...
const COUNTRIES = [
  ...
  { code: 'ca', name: 'Canada', test: 'Canadian citizenship test', language: 'en',
    // Canada's test may be taken in either official language, and IRCC publishes the
    // guide in both, so both are offered. The French pack is written from the French
    // guide rather than translated from ours - its terms of art are the ones a French
    // candidate will actually read ("d'un océan à l'autre", not "from sea to sea").
    versions: [
      { id: 'practice', file: 'practice-questions.json', label: 'English' },
      { id: 'practice-fr', file: 'practice-questions-fr.json', label: 'Français' },
    ], flag: `<svg viewBox="0 0 19 10" style="width:100%;height:100%;display:block"><rect width="19" height="10" fill="#fff"/><rect width="4.75" height="10" fill="#D80621"/><rect x="14.25" width="4.75" height="10" fill="#D80621"/></svg>` },
